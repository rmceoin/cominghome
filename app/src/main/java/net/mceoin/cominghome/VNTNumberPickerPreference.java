 ...
 *
 * Grabbed from https://github.com/vanniktech/VNTNumberPickerPreference
 */
...
public class VNTNumberPickerPreference extends DialogPreference {
    ...
    public VNTNumberPickerPreference(final Context context, final AttributeSet attrs) {
        ...
        mSummary = a.getString(R.styleable.VNTNumberPickerPreference_summary);
    ...
    private void updateSummary() {
        super.setSummary(mSelectedValue + " " + mSummary);
    }
}
